...
async function loadPokemon(id) {
    try {
        ...
        const abilitiesWrapper = document.querySelector(".pokemon-detail-wrap .move");
...
function displayPokemonDetails(pokemon) {
    ...
    document.querySelector(".pokemon-detail .weight").textContent = `${weight / 10}kg`;
    document.querySelector(".pokemon-detail .height").textContent = `${height / 10}m`;
    ...
    stats.forEach(({ stat, base_stat }) => {
        ...
        createAndAppendElement(statDiv, "p", {
            ...
            textContent: statsNameMapping[stat.name] || stat.name.toUpperCase()
        });
